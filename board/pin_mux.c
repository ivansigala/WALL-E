...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port0_27_pinB12_config = {/* Internal pull-up/down resistor is disabled */
                                                      ...
                                                      /* Pin Control Register fields [15:0] are not locked */
                                                      kPORT_UnlockRegister};
    /* PORT0_27 (pin B12) is configured as PIO0_10 */
    ...
    const port_pin_config_t port4_3_pinU12_config = {/* Internal pull-up/down resistor is disabled */
                                                      kPORT_PullDisable,
                                                      /* Low internal pull resistor value is selected. */
                                                      kPORT_LowPullResistor,
                                                      /* Fast slew rate is configured */
    ...
    PORT_SetPinConfig(PORT4, 3U, &port4_3_pinU12_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
